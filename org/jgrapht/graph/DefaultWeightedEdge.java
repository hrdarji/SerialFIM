    ...
    extends DefaultEdge
{
    ...
    double weight1 = WeightedGraph.DEFAULT_EDGE_WEIGHT;
    double weight2 = WeightedGraph.DEFAULT_EDGE_WEIGHT;
    BigDecimal bigweight1 = new BigDecimal(WeightedGraph.DEFAULT_EDGE_WEIGHT);

    //~ Methods ----------------------------------------------------------------

    public BigDecimal getBigweight1() {
		return bigweight1;
	}
	/**
