        ...
        Serializable
{
    ...
    public double getEdgeWeight1(E e)
    {
        if (e instanceof DefaultWeightedEdge) {
            return ((DefaultWeightedEdge) e).getWeight1();
        } else {
            return WeightedGraph.DEFAULT_EDGE_WEIGHT;
        }
    }
    
    public double getEdgeWeight2(E e)
    {
        if (e instanceof DefaultWeightedEdge) {
            return ((DefaultWeightedEdge) e).getWeight2();
        } else {
            return WeightedGraph.DEFAULT_EDGE_WEIGHT;
        }
    }
    
    public BigDecimal getEdgeWeight1big(E e)
    {
        if (e instanceof DefaultWeightedEdge) {
            return ((DefaultWeightedEdge) e).getBigweight1();
        } else {
            return (new BigDecimal(WeightedGraph.DEFAULT_EDGE_WEIGHT));
        }
    }
    ...
    /**
     * @see WeightedGraph#setEdgeWeight(Object, double, double)
     */
    public void setEdgeWeight(E e, double weight1,double weight2)
    {
        assert (e instanceof DefaultWeightedEdge) : e.getClass();
        ((DefaultWeightedEdge) e).weight1 = weight1;
        ((DefaultWeightedEdge) e).weight2 = weight2;
    }
    
    public void setEdgeWeight(E e, BigDecimal weight1,double weight2)
    {
        assert (e instanceof DefaultWeightedEdge) : e.getClass();
        ((DefaultWeightedEdge) e).bigweight1 = weight1;
        ((DefaultWeightedEdge) e).weight2 = weight2;
    }
