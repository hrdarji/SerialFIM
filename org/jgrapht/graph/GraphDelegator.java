        ...
        Serializable
{
    ...
    {
        return delegate.getEdgeWeight1(e);
    }
    
    public double getEdgeWeight2(E e)
    {
        return delegate.getEdgeWeight2(e);
    }
    @Override
	public BigDecimal getEdgeWeight1big(E e) {
		
		return delegate.getEdgeWeight1big(e);
	}
    ...
    {
        ((WeightedGraph<V, E>) delegate).setEdgeWeight(e, weight1,weight2);
    }
